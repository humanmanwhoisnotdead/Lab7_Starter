...
export class Router {
  ...
  navigate(page, statePopped) {
    ...
    if (typeof this[page] == 'undefined' || typeof this[page] == null || typeof this[page] == undefined) {
      console.log('error navigate pages function is undefined');
      return;
    } else {
      console.log('A');
      var hash;
      ...
      console.log('D');
      this[page]();
      console.log(window.location.hash + "X");
    }
  }
}